<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="OrderingFoodWebsite.User.Registration" %>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="recPostCode" runat="server" ErrorMessage="Post/Zip Code must be of 6 digits"
